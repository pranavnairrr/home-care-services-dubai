        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="btn-whatsapp whitespace-nowrap">
              ...
              <a href="#services" className="btn-primary whitespace-nowrap">
