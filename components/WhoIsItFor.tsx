      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          {PAIN_POINTS.map((p, i) => (
            <div
              key={i}
              className="bg-white rounded-2xl border border-gray-100 shadow-sm flex items-start gap-3 p-4 md:flex-col md:gap-4 md:p-6"
            >
              <div className="w-9 h-9 rounded-xl bg-[#effcf9] flex items-center justify-center text-[#004d40] shrink-0">
                {p.icon}
              </div>
